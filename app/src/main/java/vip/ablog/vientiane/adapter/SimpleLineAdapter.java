...
public class SimpleLineAdapter extends BaseQuickAdapter<SearchThinkData.ThinkTitle, BaseViewHolder> {


    public SimpleLineAdapter(List data) {
        super(R.layout.item_simple_line, data);

    }

    @Override
    protected void convert(BaseViewHolder helper, SearchThinkData.ThinkTitle title) {
        helper.setText(R.id.tv_line_title, title.getVod_name());
    }
