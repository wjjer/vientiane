...
public class HotTopAdapter extends BaseQuickAdapter<HotTopData, BaseViewHolder> {


    public HotTopAdapter(int layout,List data) {
        super(layout, data);

    }

    @Override
    protected void convert(BaseViewHolder helper, HotTopData item) {
        helper.setText(R.id.tv_top_title, item.getTitle());
        helper.setText(R.id.tv_top_num, item.getNumber());
    }
