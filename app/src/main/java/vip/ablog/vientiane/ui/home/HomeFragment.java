package vip.ablog.vientiane.ui.home;
...
public class HomeFragment extends Fragment{
    ...
    public HomeFragment(BannerChangeListener bannerChangeListener) {
    ...
    public static HomeFragment newInstance(int type, BannerChangeListener bannerChangeListener) {

        Bundle args = new Bundle();
        HomeFragment fragment = new HomeFragment(bannerChangeListener);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        initMagicIndicator();
        myPageAdapter = new MyPageAdapter(getParentFragmentManager(), mDataList, mTitlesList);
