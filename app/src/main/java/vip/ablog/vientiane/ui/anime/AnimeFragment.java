package vip.ablog.vientiane.ui.anime;
...
public class AnimeFragment extends Fragment implements BannerChangeListener {
    ...
    public AnimeFragment(BannerChangeListener bannerChangeListener) {
    ...
    public static AnimeFragment newInstance(int type, BannerChangeListener bannerChangeListener) {

        Bundle args = new Bundle();
        AnimeFragment fragment = new AnimeFragment(bannerChangeListener);
