package vip.ablog.vientiane.ui.variety; /**
 ...
 * since 2017 09 14
 */
public class VarietyFragment extends Fragment implements BannerChangeListener {
    ...
    public VarietyFragment(BannerChangeListener bannerChangeListener) {
    ...
    public static VarietyFragment newInstance(int type, BannerChangeListener bannerChangeListener) {

        Bundle args = new Bundle();
        VarietyFragment fragment = new VarietyFragment(bannerChangeListener);
